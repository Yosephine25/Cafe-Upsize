...
<?php $component->withAttributes([]); ?>
					    ...
					    <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
						    <div class="card overflow-hidden">
								<div class="card-body">
									<div class="row">
										<div class="col">
											<h3 class="mb-2 fw-semibold"><?php echo e($user); ?></h3>
						...
						<div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
							<div class="card overflow-hidden">
								<div class="card-body">
									<div class="row">
										<div class="col">
											<h3 class="mb-2 fw-semibold"><?php echo e($booking); ?></h3>
						...
						<div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
						    <div class="card overflow-hidden">
								<div class="card-body">
								    <div class="row">
										<div class="col">
											<h3 class="mb-2 fw-semibold"><?php echo e($kritik); ?></h3>
						...
						<div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
							<div class="card overflow-hidden">
								<div class="card-body">
									<div class="row">
										<div class="col">
											<h3 class="mb-2 fw-semibold"><?php echo e($order); ?></h3>
						...
						<div class="col-sm-12 col-md-12 col-lg-6 col-xl-8">
							...
							<div class="card-body">
							  	<div class="sales-stats d-flex">
									<div>
								  		<div class="text-muted fs-13">Total Pendapatan Tahun <?php echo e($year); ?>

								  	</div>
								  	<h3 class="fw-semibold">Rp. <?php echo e($yeartotal); ?></h3>
								</div>
							</div>
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
							<div class="card fullscreen-card">
								...
								<div class="card-body">
									<div class="sales-stats d-flex">
										<div>
											<div class="text-muted fs-13">Menu favorit <?php echo e($year); ?></div>
											<div class="most-ordered-product" >
												<h4>Produk Paling Banyak Dibeli</h4>
												<?php if($mostOrderedProduct): ?>
													<p>Nama Produk: <span style="font-weight: bold;"><?php echo e($mostOrderedProduct->title); ?></span></p>
													<p>Jumlah Pembelian: <span style="font-weight: bold;"><?php echo e($mostOrderedProduct->order_details_count); ?></span></p>
												<?php else: ?>
	...
	<script>
		...
		var chart = new Chart(ctx, {
			...
			datasets: [{
				label: 'Sales',
				data: [<?php echo e($januarySum); ?>, <?php echo e($februarySum); ?>, <?php echo e($maretSum); ?>, <?php echo e($aprilSum); ?>, <?php echo e($meiSum); ?>, <?php echo e($juneSum); ?>,<?php echo e($julySum); ?>,<?php echo e($augustSum); ?>,<?php echo e($septemberSum); ?>,<?php echo e($octoberSum); ?>,<?php echo e($novemberSum); ?>,<?php echo e($decemberSum); ?>],
	...
	<script>
		...
		var chart = new Chart(ctx, {
			type: 'bar',
			data: {
				labels: <?php echo $productTitles; ?>,
				datasets: [{
					label: 'Checkout Count',
					data: <?php echo $productCheckoutCounts; ?>,
					backgroundColor: 'rgba(54, 162, 235, 0.5)',
					borderColor: 'rgba(54, 162, 235, 1)',
					borderWidth: 1
				}]
...
<?php endif; ?><?php /**PATH D:\laragon\www\CafeUpsize\resources\views/pages/admin/dashboard/home.blade.php ENDPATH**/ ?>