                            ...
                            <div class="card">
                                <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="ms-auto pageheader-btn">
                                        <a href="<?php echo e(route('admin.kritik.export.pdf')); ?>" class="btn btn-primary">Ekspor PDF</a>
                                    </div>
                                </div>  
                                <div class="ms-auto pageheader-btn">
                                </div>
...
<?php endif; ?><?php /**PATH D:\laragon\www\CafeUpsize\resources\views/pages/admin/kritik/main.blade.php ENDPATH**/ ?>