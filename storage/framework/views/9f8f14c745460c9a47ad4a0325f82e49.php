                        ...
                        <td>
                            <ul class="list-inline hstack gap-2 mb-0">
                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                    ...
                                    <a href="javascript:;"
                                    onclick="handle_confirm('Apakah Anda Yakin?','Yakin','Tidak','DELETE','<?php echo e(route('admin.pengaduan.destroy',$item->id)); ?>');"
...
<?php /**PATH D:\laragon\www\CafeUpsize\resources\views/pages/admin/pengaduan/list.blade.php ENDPATH**/ ?>