            ...
            <table class="table align-middle">
                ...
                <tbody class="list form-check-all">
                    ...
                    <tr>
                        ...
                        <td><?php echo e($item->pengaduan); ?></td>
                        <td>
                            <ul class="list-inline hstack gap-2 mb-0">
                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                    data-bs-placement="top" title="" data-bs-original-title="Remove">
                                    <a href="javascript:;"
                                    onclick="handle_confirm('Apakah Anda Yakin?','Yakin','Tidak','DELETE','<?php echo e(route('staff.historypengaduan.destroy',$item->id)); ?>');"
...
<?php /**PATH D:\laragon\www\CafeUpsize\resources\views/pages/staff/historypengaduan/list.blade.php ENDPATH**/ ?>