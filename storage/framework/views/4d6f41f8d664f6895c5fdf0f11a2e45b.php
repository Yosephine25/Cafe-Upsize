                            ...
                            <div class="card">
                                <div class="card-header border-bottom">
                                    ...
                                    <div class="ms-auto pageheader-btn">
                                        <a href="<?php echo e(route('admin.historyorder.export.pdf')); ?>" class="btn btn-primary">Ekspor PDF</a>
                                    </div>
                                </div>
                                <div class="ms-auto pageheader-btn">
                                </div>
...
<?php endif; ?><?php /**PATH D:\laragon\www\CafeUpsize\resources\views/pages/admin/historyorder/main.blade.php ENDPATH**/ ?>