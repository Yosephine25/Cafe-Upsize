...
class HomeController extends Controller
{
    ...
    public function favorit()
    {
        ...
        return view('pages.staff.dashboard.main', compact('user', 'booking', 'kritik', 'order', 'januarySum', 'februarySum', 'maretSum', 'aprilSum', 'meiSum', 'juneSum', 'julySum', 'augustSum', 'septemberSum', 'octoberSum', 'novemberSum', 'decemberSum', 'year', 'yeartotal', 'productTitles', 'productCheckoutCounts', 'mostOrderedProduct'));
    }
}
